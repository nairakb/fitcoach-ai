...
# Try reading from environment variable first, then fallback to deployment_metadata.json
...
if metadata_file.exists():
    try:
        with open(metadata_file) as f:
            meta = json.load(f)
            default_resource = meta.get("remote_agent_runtime_id")
    except Exception:
        pass

RESOURCE = os.environ.get(
    "AGENT_ENGINE_RESOURCE_NAME",
    default_resource or "projects/744804734982/locations/us-east1/reasoningEngines/2518644688676716544",
)
